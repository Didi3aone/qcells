...
function form_ajax_submit (form, extra_data) {
    $(form).ajaxSubmit({
        dataType: 'json',
        data: extra_data,
        beforeSend: function() {
        ...
        success: function(data) {
            ...
            if (data['is_error']) {
                ...
                $.smallBox({
                    ...
                    //triger form submit success
                    $(document).trigger("form-submit:success", [form,data]);
                    ...
                    if (data['redirect_to'] == "") {
                        ...
                        //triger form submit no redirection
                        $(document).trigger("form-submit:noredirect", [form,data]);
                    } else {
                        go(data['redirect_to']);
                    }
                });
...
function init_tinymce (selector = ".tinymce") {
    tinymce.init({
        selector: selector,
        height: 300,
        menubar: false,
        plugins: [
          "code fullscreen preview table visualblocks contextmenu responsivefilemanager link image media lists "
        ],
        ...
        toolbar2: "bullist numlist | link unlink image responsivefilemanager media code",
        image_advtab: true ,
        external_filemanager_path:"/qcell/assets/js/plugins/filemanager/",
        filemanager_title:"Responsive Filemanager" ,
        external_plugins: { "filemanager" : "/qcell/assets/js/plugins/filemanager/plugin.min.js"},
        ...
        //     }
        //
        //     editor.addButton('focus1Node', {
        //         text: 'Focus one Node',
        //         icon: false,
        //         onclick: function() {
        //             // Open window
        //             editor.windowManager.open({
        //                 title: 'Focus one Node',
        //                 body: [
