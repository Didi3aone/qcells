var lists = function () {
    ...
    var ajax_source = "/manager/slider/list_all_data";
    ...
    var columns = [
        ...
        },
        {
            ...
            "render": function(data, type, full) {
                var edit =  '<td>';
                    edit +=  ' <a href="/manager/slider/edit/' + full.id + '" class="btn btn-primary btn-circle" rel="tooltip" title="Edit Slider" data-placement="top" ><i class="fa fa-pencil"></i></a>' +
                             ' <a href="/manager/slider/delete" data-id ="' + full.id + '" data-name ="' + full.title + '" class="btn btn-danger btn-circle delete-confirm" rel="tooltip" title="Delete Slider" data-placement="top" ><i class="fa fa-trash-o"></i></a>';
                    edit +=  '</td>';
...
$(document).ready(function() {
    ...
    $(document).on("change", ".order_data", function(e) {
		e.stopPropagation();
		e.preventDefault();
		var url = "/manager/slider/ordering";
