...
class Index_manager extends CI_Controller  {
    ...
    private $_view_folder = "index/manager/";
	...
	public function login() {
        ...
        $footer = array("script" => 'assets/js/pages/index/manager/login.js');
	...
	public function forgot_password() {
        ...
        $footer = array("script" => '/js/pages/index/manager/login.js');
