        ...
        <link rel="stylesheet" type="text/css" media="screen" href="<?= base_url(); ?>assets/js/plugins/cropper/cropper.min.css">
        <link rel="stylesheet" type="text/css" media="screen" href="<?= base_url(); ?>assets/js/plugins/cropper/crop.css">
		...
		<script src="<?= base_url(); ?>assets/js/crop-master.js"></script>
        <?php
