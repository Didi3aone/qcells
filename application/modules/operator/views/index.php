...
<div id="content">
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-5 col-lg-4 col-lg-offset-1 text-right">
			<h1>
				<a class="btn btn-primary" href="/qcell/manager/operator/create" rel="tooltip" title="Add new Operator" data-placement="left">
							...
							<table id="dataTable" class="table table-striped table-bordered table-hover" width="100%">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th data-class="expand"> Nama Operator</th>
                                        <th data-hide="phone,tablet"> Jenis Kartu</th>
                                        <th data-hide="phone,tablet"> Logo Provider</th>
